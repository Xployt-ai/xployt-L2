...
shim so legacy scripts that still import ``utils.state_utils`` continue
...
# ---------------------------------------------------------------------------
#   Old code frequently does ``from utils.state_utils import data_dir``.
...
_sys.modules.setdefault("utils.state_utils", _import_module("xployt_lvl2.utils.state_utils"))
_sys.modules.setdefault("xployt_lvl2.config.state", _import_module("xployt_lvl2.utils.state_utils"))
